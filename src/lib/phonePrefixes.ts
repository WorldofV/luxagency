export const phonePrefixOptions = [
  ...
  { value: "+39", label: "+39 · Italy / Vatican" },
  ...
  { value: "+246", label: "+246 · Diego Garcia" },
  ...
  { value: "+508", label: "+508 · Saint Pierre & Miquelon" },
  { value: "+509", label: "+509 · Haiti" },
  { value: "+590", label: "+590 · Guadeloupe / Saint-Martin" },
  ...
  { value: "+672", label: "+672 · Norfolk Island / Antarctica" },
